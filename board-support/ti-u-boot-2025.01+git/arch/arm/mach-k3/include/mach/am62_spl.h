...
/* ===== CRZ ADDED: alias needed by common/spl/spl_nand.c (SPL_LOAD_IMAGE_METHOD
 * registers BOOT_DEVICE_NAND); am64_spl.h/am62l_spl.h carry the same define ===== */
#define BOOT_DEVICE_NAND		BOOT_DEVICE_GPMC_NAND
