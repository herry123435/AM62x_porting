...
override KERNELDIR := /home/hgchoe/project/am62x/am62x_ubuntu_20231122/board-support/ti-linux-kernel
override KERNEL_ID := 6.1.33
override PVRSRV_MODULE_BASEDIR := /lib/modules/6.1.33/extra/
override KERNEL_COMPONENTS := srvkm
override KERNEL_CROSS_COMPILE := /opt/arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-
override WINDOW_SYSTEM := wayland
override PVRSRV_MODNAME := pvrsrvkm
override PVR_BUILD_DIR := am62_linux
override PVR_BUILD_TYPE := release
override SUPPORT_RGX := 1
override PVR_SYSTEM := axe_am62
override PVR_LOADER :=
override BUILD := release
override SORT_BRIDGE_STRUCTS := 1
override DEBUGLINK := 1
override RGX_BNC := 33.V.11.3
override SUPPORT_PHYSMEM_TEST := 1
override SUPPORT_MIPS_64K_PAGE_SIZE := 1
